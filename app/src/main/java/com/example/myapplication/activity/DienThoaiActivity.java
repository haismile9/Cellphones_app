...
public class DienThoaiActivity extends AppCompatActivity {
    ...
    private void getData(int page) {
        compositeDisposable.add(apiBanHang.getSanPham(page, loai)
                ...
                .subscribe(
                        ...
                        throwable -> {
                            Log.e("loggg", "Lỗi: " + throwable.getMessage());
                            Toast.makeText(getApplicationContext(), "Không kết nối được tới server", Toast.LENGTH_SHORT).show();
                        }
                ));
    }
    ...
    private void ActionToolBar() {
        ...
        // Đặt tiêu đề cho ActionBar Laptop
